...
namespace Cornerstone.Service.CommonService
{
    public class DatabaseTableMySqlService : RepositoryBase, IDatabaseTableService
    {
        ...
        /// <summary>
        /// 仅用在Cornerstone框架里面，同步不同数据库之间的数据，以 MySql 为主库，同步 MySql 的数据到SqlServer和Oracle，保证各个数据库的数据是一样的
        /// </summary>
        /// <returns></returns>
        ...
        {
            string sqlServerConnectionString = "localhost;Initial Catalog = CornerstoneNetDb;User ID=sa;Password=1q2w3e4r;MultipleActiveResultSets=true";
