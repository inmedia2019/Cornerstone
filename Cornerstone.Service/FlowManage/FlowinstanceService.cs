...
using Chloe;
using Cornerstone.Domain.FlowManage;
using Cornerstone.Domain.SystemManage;
using Cornerstone.Service.CommonService;
...
namespace Cornerstone.Service.FlowManage
{
    /// <summary>
    /// 创 建：超级管理员
    ...
    public class FlowinstanceService : DataFilterService<FlowinstanceEntity>, IDenpendency
    {
        ...
        private string cacheKey = "Cornerstone_flowinstancedata_";
        ...
        public async Task CreateInstance(FlowinstanceEntity entity)
        {
            ...
            if (entity.F_FrmType == 1)
            {
                ...
                var t = referencedAssemblies
                    .SelectMany(a => a.GetTypes().Where(t => t.FullName.Contains("Cornerstone.Service.") && t.FullName.Contains("."+entity.F_DbName + "Service"))).FirstOrDefault();
