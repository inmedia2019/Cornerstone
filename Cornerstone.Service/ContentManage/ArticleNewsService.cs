...
namespace Cornerstone.Service.ContentManage
{
    ...
    public class ArticleNewsService : DataFilterService<ArticleNewsEntity>, IDenpendency
    {
        ...
        private string cacheKey = "Cornerstone_cms_articlenewsdata_";
        ...
        public async Task SubmitForm(ArticleNewsEntity entity, string keyValue)
        {
            ...
            {
                entity.F_Zhaiyao = Cornerstone.Code.TextHelper.GetSubString(Cornerstone.Code.WebHelper.NoHtml(entity.F_Description),255);
            }
