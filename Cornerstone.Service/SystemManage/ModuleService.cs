...
namespace Cornerstone.Service.SystemManage
{
    public class ModuleService : DataFilterService<ModuleEntity>, IDenpendency
    {
        ...
        private string modulebuttoncacheKey = "Cornerstone_modulebuttondata_";
        private string modulefieldscacheKey = "Cornerstone_modulefieldsdata_";
