...
namespace Cornerstone.Code
{
    public class OperatorProvider
    {
        ...
        //Cornerstone_operator_pc_ PC端登录
        //Cornerstone_operator_info_ 登录次数
        //
        /// <summary>
        /// 缓存操作类
        /// </summary>
        private string cacheKeyOperator = "Cornerstone_operator_";// +登录者token
        private string cacheKeyToken = "Cornerstone_token_";// +登录者token
        private string cacheKeyError = "Cornerstone_error_";// + Mark
        /// <summary>
        /// 秘钥
        /// </summary>
        private string LoginUserToken = "Cornerstone_Token";
        /// <summary>
        /// 标记登录的浏览器
        /// </summary>
        private string LoginUserMarkKey = "Cornerstone_Mark";
