...
namespace Cornerstone.CodeGenerator
{
    public class SingleTableTemplate
    {
        private string buttoncacheKey = "Cornerstone_modulebuttondata_";
        private string fieldscacheKey = "Cornerstone_modulefieldsdata_";
        private string cacheKey = "Cornerstone_moduleldata_";
        private string quickcacheKey = "Cornerstone_quickmoduledata_";
        private string initcacheKey = "Cornerstone_init_";
        private string authorizecacheKey = "Cornerstone_authorizeurldata_";// +权限
        ...
        public BaseConfigModel GetBaseConfig(string path,string username, string tableName, string tableDescription, Dictionary<string,string> tableFieldList)
        {
            ...
            baseConfigModel.OutputConfig.OutputEntity = Path.Combine(path, "Cornerstone.Domain\\Entity");
            baseConfigModel.OutputConfig.OutputService = Path.Combine(path, "Cornerstone.Service");
            baseConfigModel.OutputConfig.OutputWeb = Path.Combine(path, "Cornerstone.Web");
            #endregion
        ...
        public string BuildEntity(BaseConfigModel baseConfigModel, DataTable dt,string idColumn = "F_Id")
        {
            ...
            //sb.AppendLine("using Cornerstone.Code;");
            sb.AppendLine("using Chloe.Annotations;");
            sb.AppendLine();

            sb.AppendLine("namespace Cornerstone.Domain." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
        ...
        public string BuildService(BaseConfigModel baseConfigModel, DataTable dt, string idColumn = "F_Id")
        {
            ...
            sb.AppendLine("using Cornerstone.Domain." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Cornerstone.Service." + baseConfigModel.OutputConfig.OutputModule);
            sb.AppendLine("{");
            ...
            sb.AppendLine("    {");                    
            sb.AppendLine("        private string cacheKey = \"Cornerstone_" + baseConfigModel.FileConfig.ClassPrefix.ToLower() + "data_\";");
        ...
        public string BuildController(BaseConfigModel baseConfigModel, string idColumn="F_Id")
        {
            ...
            sb.AppendLine("using Cornerstone.Code;");
            sb.AppendLine("using Cornerstone.Domain." + baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine("using Cornerstone.Service;");
            sb.AppendLine("using Microsoft.AspNetCore.Authorization;");
            sb.AppendLine("using Cornerstone.Service."+ baseConfigModel.OutputConfig.OutputModule + ";");
            sb.AppendLine();

            sb.AppendLine("namespace Cornerstone.Web.Areas." + baseConfigModel.OutputConfig.OutputModule + ".Controllers");
            sb.AppendLine("{");
        ...
        public string BuildIndex(BaseConfigModel baseConfigModel, string idColumn = "F_Id")
        {
            ...
            if (baseConfigModel.PageIndex.IsTree==1)
            {
                ...
                sb.AppendLine("             url: '@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/GetTreeGridJson'+(!queryJson ? '' : '?keyword=' + queryJson),"); sb.AppendLine("             sqlkey: '"+ idColumn + "',//数据库主键");
                sb.AppendLine("             cols: [[");
                sb.AppendLine("                 //此处需修改");
                int cout = 1;
            ...
            else
            {
                ...
                sb.AppendLine("             url: '@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/GetGridJson',");
            ...
            sb.AppendLine("                     url: \"@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/Form\",");
            ...
            sb.AppendLine("                     url: \"@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/DeleteForm\",");
            ...
            sb.AppendLine("                   url: \"@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/Form?keyValue=\" + entity.data." + idColumn + ",");
            sb.AppendLine("                   width: \"500px\",");
            sb.AppendLine("                   height: \"500px\",");
            sb.AppendLine( "               });");
            sb.AppendLine( "           }");
            ...
            sb.AppendLine("                   url: \"@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/Details?keyValue=\" + entity.data." + idColumn + ",");
            sb.AppendLine("                   width: \"500px\",");
            sb.AppendLine("                   height: \"500px\",");
            sb.AppendLine( "                  btn: []");
            sb.AppendLine( "               });");
        ...
        public string BuildForm(BaseConfigModel baseConfigModel)
        {
            ...
            sb.AppendLine("                   url: '@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/GetFormJson',");
            ...
            sb.AppendLine("               url: '@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/SubmitForm?keyValue=' + keyValue,");
        ...
        public string BuildMenu(BaseConfigModel baseConfigModel, string idColumn = "F_Id")
        {
            ...
            foreach (string btn in baseConfigModel.PageIndex.ButtonList)
            {
                ...
                string url = "@(Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory)/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/" + form;
        ...
        public async Task<List<KeyValue>> CreateCode(BaseConfigModel baseConfigModel, string code)
        {
            ...
            if (!param["CodeIndex"].IsEmpty())
            {
                ...
                string menuUrl = Cornerstone.Code.GlobalContext.SystemConfig.VirtualDirectory +"/" + baseConfigModel.OutputConfig.OutputModule + "/" + baseConfigModel.FileConfig.ClassPrefix + "/" + baseConfigModel.FileConfig.PageIndexName;
