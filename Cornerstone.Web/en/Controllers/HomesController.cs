...
namespace Cornerstone.Web.en.Controllers
{
    ...
    public class HomesController : Controller
    {
        ...
        {
            var data =  _contentService.GetListByChannelId("60b49913-71a0-4ba3-81bb-1350d7502679").Result;
            ...
            var newsData = _contentService.GetListByChannelId("f91beac0-09fb-4e28-ade3-66d720abbd65", 1, 6).Result;
        ...
        public ActionResult Head()
        {
            ...
            return PartialView("~/Areas/en/Views/Shared/_Head.cshtml");
        }
        public ActionResult Foot()
        {
            
            return PartialView("~/Areas/en/Views/Shared/_Foot.cshtml");
