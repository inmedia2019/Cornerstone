...
namespace Cornerstone.Web.en.Controllers
{
    ...
    public class about_usController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var data =  _contentService.GetListByChannelId("ec2546f7-865c-4db0-901e-3de27971c73c").Result;
            ...
            var developData= _contentService.GetListByChannelIds("cdcbf0d7-6771-4566-bfeb-6ac7b5b33201").Result;
