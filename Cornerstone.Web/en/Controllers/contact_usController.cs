...
namespace Cornerstone.Web.en.Controllers
{
    ...
    public class contact_usController : Controller
    {
       ...
       // public QuestiontypeinfoService _questiontypeinfoService { get; set; }
        ...
        {
            //查询banner
            string bannerId = "522f0314-0055-40a0-bee5-07c9103fbf7b";
            ...
            {
                bannerId = "5218d2aa-477f-44a1-96c9-8b4965a2c710";
            }
            ...
            var backGround = _blockService.GetBannerById("7939f3c9-c825-4204-b8bd-44cbe8a86293").Result;
            ...
            backGround.F_Content = OSSHelper.GetOSSUrl(backGround.F_Content.Replace("\\\"", "\""));
            ...
            var data = _contactinfoService.GetBannerByChannelId("8a38c314-4bdd-480a-bdc7-93c585ad8164").Result;
                        ...
                        returnHtml += "<div class=\"flex f16 alignitems_center justify_between\">" +
                                    ...
                                    "<div class=\"flex alignitems_center\" style=\"width:230px;" + (data[j].F_Tel == "" ? "opacity:0;" : "") + "" + GetStyleInfo(reg.IsMatch(uAgent), data[j].F_Tel) + "\">" +
                                        "<div class=\"f14\" style=\"letter-spacing:1px;\">" +
                                            "<span class=\"fb\">Tel：</span>" + data[j].F_Tel +
                                        "</div>" +
                                   " </div>" +
            ...
            var seoData = _contentService.GetListByChannelId("8a38c314-4bdd-480a-bdc7-93c585ad8164", 1, 1).Result.FirstOrDefault();
