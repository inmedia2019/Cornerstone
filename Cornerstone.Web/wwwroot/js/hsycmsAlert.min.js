/** hsycmsAlert 弹窗插件* author QQ:564379992 http://www.hsycms.com */
var hsycmsalert_model_html = "";
hsycmsalert_model_html +=
	" <div class=\"hsycms-model-mask\" onclick=\"hsycms.closeAll()\" id=\"hsycmsalert-mask-model\"></div>";
...
hsycmsalert_success_html +=
	"   <circle class=\"hsycms-alert-svgcircle\"  cx=\"25\" cy=\"25\" r=\"24\" fill=\"none\" stroke=\"#14d6a2\" stroke-width=\"2\"></circle>   ";
hsycmsalert_success_html +=
	"   <polyline class=\"hsycms-alert-svggou\" fill=\"none\" stroke=\"#14d6a2\" stroke-width=\"2.5\" points=\"14,25 23,34 36,18\" stroke-linecap=\"round\" stroke-linejoin=\"round\" />";
...
hsycmsalert_fail_html += "<div class=\"hsycms-model-mask\" id=\"hsycmsalert-mask-error\"></div>";
...
var hsycms = function() {
	return {
		...
		fail: function(id, txt, callback, time = 1600) {
			this.open(id, txt);
			let that = this;
			setTimeout(res => {
				that.close(id);
