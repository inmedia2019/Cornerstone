...
namespace Cornerstone.Web.Controllers
{
    public class education_and_trainingController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            //查询banner
            string bannerId = "7a51ec04-fa2d-45d7-93cd-683b17d5e0ab";
            ...
            //标签
            var tagData = _lableService.GetListByLan("0").Result;
            ...
            //查询科室/部门
            ViewBag.Department = _departmentService.GetListByLan("0").Result;

            //查询过往经验
            ViewBag.History = _historyService.GetListByLan("0").Result;

            // ViewBag.Info = data;
            ViewBag.banner = bannerData;
            ViewBag.tagData = tagData;
            ViewBag.Count = _contentService.GetListCountByChannelId("7a51ec04-fa2d-45d7-93cd-683b17d5e0ab").Result;
            return View();
        ...
        {
            var data = _contentService.GetListByChannelId("7a51ec04-fa2d-45d7-93cd-683b17d5e0ab", currentPage, 9, tagId).Result;
            string returnStr = "[";
            string temp = "";
