...
namespace Cornerstone.Web.Controllers
{
    public class product_centerController : Controller
    {
        ...
        {
            //查询banner
            string bannerId = "0793b211-c656-43f7-b821-fdc8bb6c903d";
            ...
            {
                bannerId = "f93ac5e7-216b-4db0-b851-6694683921e8";
            }
            ...
            var data =  _contentService.GetListByChannelId("1afe409f-5b17-4743-ba3a-82018a456f1b").Result;
            if (data != null)
            {
