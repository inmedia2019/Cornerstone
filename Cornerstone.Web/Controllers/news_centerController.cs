...
namespace Cornerstone.Web.Controllers
{
    public class news_centerController : Controller
    {
        ...
        {
            //查询banner
            string bannerId = "15ed6269-a4d8-4ddc-9e2d-0761413b2951";
            ...
            else
            {
                ...
                bannerId = "1807667e-8a2c-42c0-a5fe-a09350dc8dda";
            }
            ...
            var data = _contentService.GetListByChannelId("f91beac0-09fb-4e28-ade3-66d720abbd64", 1, 1).Result.FirstOrDefault();
            ...
            var count = _contentService.GetListCountByChannelId("f91beac0-09fb-4e28-ade3-66d720abbd64").Result;

            var bottom = _blockService.GetBannerById("39bf5cca-561f-4690-9355-e329176b21a9").Result;
            ...
            ViewBag.Count = count;
            ViewBag.bottomBanner = OSSHelper.GetOSSUrl(bottom.F_ImageUrl);
        ...
        {
            var data = _contentService.GetListByChannelId("f91beac0-09fb-4e28-ade3-66d720abbd64", currentPage, 10).Result;
            string returnStr = "";
            for (int i = 0; i < data.Count; i++)
            {
                returnStr += "<a href=\"Newsdis/Index/" + data[i].F_Id + "\" target=\"_blank\">" +
